  ...
  const loadDashboardStats = async () => {
    ...
    try {
      ...
      setStats({
        ...
        activeReferrals: poolSpecificActiveReferrals, // Pool-specific
        ...
        poolStatus, // Add poolStatus to stats
      });
  ...
  return (
    <div className="p-0 space-y-6">
      ...
      <div className="p-4 sm:p-6">
        ...
        sponsorIncome: stats?.sponsorIncome,
        todayIncome: stats?.todayIncome,
        yesterdayIncome: stats?.yesterdayIncome,
      }} />
        {/* Quick Stats Grid */}
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium text-gray-900">
                        {stats.poolTimeRemaining} {stats.poolStatus}
                      </span>
                    </div>
                    <Progress 
                      value={poolProgress} 
